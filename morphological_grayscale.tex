...
\begin{table*}[t!]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{p{2cm}|p{5cm}|p{5cm}|p{5cm}}
			...
			\hline
			$n$ & Number of bins of the analyzed histograms (and we limit to analyse 144 histograms)& $0 \le n \le 256$ & Even if for $n > 30$ we already achieve 90\% accuracy, we set $n$ at the highest value, i.e., considering all bins.\\
			\hline
