...
\corresp{Corresponding author: Giulia Boato (e-mail: boato@disi.unitn.it).}
...
\begin{figure}[h!]
	...
	\begin{tabular}{cc}
		\centering
		\includegraphics[scale=1.5]{original.eps} & \includegraphics[scale=0.15]{mask.png} \\
		\includegraphics[scale=1.5]{eroded.eps} &  \includegraphics[scale=1.5]{dilated.eps} \\
	\end{tabular}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{a1.png}}]{Giulia Boato} (M'76--SM'81--F'87) and all authors may include 
