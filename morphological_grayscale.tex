...
\begin{table*}
	\centering
	\caption{Detailed results on erosion and dilation detection on UCID, Dresden and RAISE-1k datasets. Average results are summarised in Table~\ref{table:detection_results}}
	\label{table:details}
